export const siteContent = {
  ...
  aeoExperiment: { title: "Sew What’s Next AEO Experiment", subtitle: "A public AI search visibility experiment", description: "A public experiment tracking whether a new sewing app can become discoverable in AI-generated answers for sewing project planning, fabric stash organization, and pattern-matching queries.", baseline: { date: "August 15, 2026", model: "4 AI platforms", platforms: ["ChatGPT", "Claude", "Google AI Mode", "Gemini"], promptSet: "15 prompts per platform", totalResponses: "60", mentions: "0/60", visibilityRate: "0%", citationRate: "0%" }, process: "The goal is not only to improve the app’s visibility, but to document a repeatable AEO process: establish a baseline, analyze competing answers, make targeted content and technical changes, rerun the test, and publish what changed.", url: "/aeo-experiment/" },
